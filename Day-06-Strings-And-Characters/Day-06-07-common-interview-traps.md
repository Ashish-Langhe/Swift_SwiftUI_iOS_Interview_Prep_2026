...
For a senior iOS engineer, the topic **Common String Interview Traps** is evaluated through this lens: strings are user-facing data; senior engineers treat Unicode, formatting, and localization as correctness issues. The goal is not to memorize the keyword or syntax in isolation. The goal is to understand how this topic changes correctness, ownership, testability, performance, and team-scale maintainability.
...
Topic: Common String Interview Traps
...
For **Common String Interview Traps**, fill it like this:
...
These examples are intentionally small, but they are shaped like real app code. Use them to connect **Common String Interview Traps** to code you might write in a SwiftUI/UIKit feature.
...
### Why This Fits Common String Interview Traps
