...
These examples are intentionally small, but they are shaped like real app code. Use them to connect **Localization Basics** to code you might write in a SwiftUI/UIKit feature.
...
```swift
let title = String(localized: "settings.notifications.title")
```

Hard-coded text becomes expensive once the app supports more regions.

### Why This Fits Localization Basics
