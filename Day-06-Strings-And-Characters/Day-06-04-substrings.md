...
For a senior iOS engineer, the topic **Substrings** is evaluated through this lens: strings are user-facing data; senior engineers treat Unicode, formatting, and localization as correctness issues. The goal is not to memorize the keyword or syntax in isolation. The goal is to understand how this topic changes correctness, ownership, testability, performance, and team-scale maintainability.
...
For **Substrings**, fill it like this:
...
These examples are intentionally small, but they are shaped like real app code. Use them to connect **Substrings** to code you might write in a SwiftUI/UIKit feature.
...
### Convert long-lived substrings to String

```swift
let email = "ashish@example.com"
let prefix = email.prefix(6)
let username = String(prefix)
```

Convert to `String` when storing a substring beyond immediate parsing.

### Why This Fits Substrings
