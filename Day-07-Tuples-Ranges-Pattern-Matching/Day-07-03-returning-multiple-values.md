...
For **Returning Multiple Values**, fill it like this:
...
These examples are intentionally small, but they are shaped like real app code. Use them to connect **Returning Multiple Values** to code you might write in a SwiftUI/UIKit feature.
...
### Why This Fits Returning Multiple Values
