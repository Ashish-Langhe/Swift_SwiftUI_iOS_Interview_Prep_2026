...
These examples are intentionally small, but they are shaped like real app code. Use them to connect **Ranges** to code you might write in a SwiftUI/UIKit feature.
...
let validPercentRange = 0.0...1.0
print(validPercentRange.contains(progress))
```

Ranges make boundaries explicit.

### Why This Fits Ranges
