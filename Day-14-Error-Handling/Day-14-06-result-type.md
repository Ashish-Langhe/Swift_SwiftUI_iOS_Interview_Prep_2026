...
For **Result Type**, fill it like this:
...
These examples are intentionally small, but they are shaped like real app code. Use them to connect **Result Type** to code you might write in a SwiftUI/UIKit feature.
...
### Represent success or failure as a value

```swift
let result: Result<User, Error> = await loadUserResult()
...
`Result` is useful when you need to store or pass a completed operation outcome.

### Why This Fits Result Type
