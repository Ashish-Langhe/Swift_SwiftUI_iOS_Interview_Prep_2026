...
Use this checklist when applying Main Actor Basics in an app feature:
...
1. Write a minimal example that shows Main Actor Basics correctly.
...
The following example is not the only way to use Main Actor Basics, but it shows the kind of production shape you should connect this topic to:
...
For **Main Actor Basics**, fill it like this:
...
These examples are intentionally small, but they are shaped like real app code. Use them to connect **Main Actor Basics** to code you might write in a SwiftUI/UIKit feature.
...
### Why This Fits Main Actor Basics
