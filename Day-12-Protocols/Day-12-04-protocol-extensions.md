...
For a senior iOS engineer, the topic **Protocol Extensions** is evaluated through this lens: protocols are boundary tools; senior engineers introduce them to express capability and dependency direction, not decoration. The goal is not to memorize the keyword or syntax in isolation. The goal is to understand how this topic changes correctness, ownership, testability, performance, and team-scale maintainability.
...
For **Protocol Extensions**, fill it like this:
...
These examples are intentionally small, but they are shaped like real app code. Use them to connect **Protocol Extensions** to code you might write in a SwiftUI/UIKit feature.
...
### Share default behavior carefully
...
extension Trackable {
    func trackViewed() {
        print("Viewed \(analyticsName)")
    }
}
```

Default implementations reduce duplication but should not hide important behavior.

### Why This Fits Protocol Extensions
