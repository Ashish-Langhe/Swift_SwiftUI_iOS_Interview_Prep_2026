...
For a senior iOS engineer, the topic **Existentials With Any** is evaluated through this lens: protocols are boundary tools; senior engineers introduce them to express capability and dependency direction, not decoration. The goal is not to memorize the keyword or syntax in isolation. The goal is to understand how this topic changes correctness, ownership, testability, performance, and team-scale maintainability.
...
For **Existentials With Any**, fill it like this:
...
These examples are intentionally small, but they are shaped like real app code. Use them to connect **Existentials With Any** to code you might write in a SwiftUI/UIKit feature.
...
### Store heterogeneous protocol values

```swift
let loggers: [any Logger] = [ConsoleLogger(), FileLogger()]
loggers.forEach { $0.log("App started") }
```

Use `any` when you need runtime polymorphism and accept the type-erasure tradeoff.

### Why This Fits Existentials With Any
