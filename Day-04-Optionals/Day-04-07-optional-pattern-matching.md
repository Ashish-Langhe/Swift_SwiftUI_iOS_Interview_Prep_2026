...
These examples are intentionally small, but they are shaped like real app code. Use them to connect **Optional Pattern Matching** to code you might write in a SwiftUI/UIKit feature.
...
### Why This Fits Optional Pattern Matching
