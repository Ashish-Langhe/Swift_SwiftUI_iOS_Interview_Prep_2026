...
These examples are intentionally small, but they are shaped like real app code. Use them to connect **Inout Parameters** to code you might write in a SwiftUI/UIKit feature.
...
```swift
func applyDiscount(to price: inout Decimal, percent: Decimal) {
    price -= price * percent
}

var total: Decimal = 100
applyDiscount(to: &total, percent: 0.10)
print(total)
```

This is useful when mutation is intentional and visible at the call site through `&`.

### Why This Fits Inout Parameters
