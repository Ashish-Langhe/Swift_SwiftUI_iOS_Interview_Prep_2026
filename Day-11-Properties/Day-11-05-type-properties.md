...
These examples are intentionally small, but they are shaped like real app code. Use them to connect **Type Properties** to code you might write in a SwiftUI/UIKit feature.
