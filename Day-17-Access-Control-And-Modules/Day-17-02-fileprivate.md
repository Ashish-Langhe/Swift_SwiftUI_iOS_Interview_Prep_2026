...
For a senior iOS engineer, the topic **fileprivate** is evaluated through this lens: access control is API economics; senior engineers decide what becomes contract and what stays replaceable. The goal is not to memorize the keyword or syntax in isolation. The goal is to understand how this topic changes correctness, ownership, testability, performance, and team-scale maintainability.
...
For **fileprivate**, fill it like this:
...
These examples are intentionally small, but they are shaped like real app code. Use them to connect **fileprivate** to code you might write in a SwiftUI/UIKit feature.
...
### Share only within one file

```swift
fileprivate struct PreviewFactory {
    static let user = User(id: "preview", name: "Preview")
}
```

File-private helpers are useful for previews and local adapters.

### Why This Fits fileprivate
