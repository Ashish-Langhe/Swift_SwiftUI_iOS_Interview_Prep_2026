...
These examples are intentionally small, but they are shaped like real app code. Use them to connect **package** to code you might write in a SwiftUI/UIKit feature.
...
### Share inside a package, not outside it

```swift
package enum FeaturePreviewData {
    package static let userID = "preview-user"
}
```

Package access is useful for multi-target Swift packages.

### Why This Fits package
